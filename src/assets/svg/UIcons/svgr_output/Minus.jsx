...
const SvgMinus = (props) => (
  ...
  >
    <defs>
      <clipPath id="minus_svg__clip-path">
        <path className="minus_svg__cls-1" d="M10.2 8.77h48.19v49.75H10.2z" />
      </clipPath>
      <style>{".minus_svg__cls-1{fill:none}"}</style>
    </defs>
    <path
      ...
      style={{
        clipPath: "url(#minus_svg__clip-path)",
      }}
    />
    <path
      style={{
